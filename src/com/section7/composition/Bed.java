...
//        and prints a message to the effect that the bed is being made;
//2) System.out.println("Bed --> Making | "); should be used in the make() method of the Bed class;
//
//        getStyle() which returns the value of style;
//        getPilows() returns the number of pillows;
